...
# Proofbound only — a contract naming a candidate and permitting project writes is candidate-bound
# execution: `bind-contract` refuses it, and this authorizes and binds in one act instead.
python3 <skill>/scripts/pb_execution.py admit ...
