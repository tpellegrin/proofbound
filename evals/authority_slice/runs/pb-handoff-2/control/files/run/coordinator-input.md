...
Every command must be run through this wrapper, which executes it inside the prepared runtime:
    ...
    /private/tmp/pbh2-control-run '<command>'

For example:

    /private/tmp/pbh2-control-run 'python3 /private/tmp/pbh2-control/workspace/harness/scripts/pb_execution.py authorize --help'
...
| | |
| --- | --- |
| Harness (scripts and worker doctrine) | `/private/tmp/pbh2-control/workspace/harness` |
| Working directory for this run | `/private/tmp/pbh2-control/workspace/work` — a **sibling** of the harness, not its parent |
| Project under change | `/private/tmp/pbh2-control/workspace/work/project` |
| Run root | `/private/tmp/pbh2-control/workspace/work/project/DeepSeekAndDestroy/plans/slice/runs/r1` |
| Ledger | `/private/tmp/pbh2-control/workspace/work/ledger.json` |
| Change graph | `/private/tmp/pbh2-control/workspace/work/project/change-graph.json` |
| Freezes | `/private/tmp/pbh2-control/workspace/work/freezes` |
| Consistency records | `/private/tmp/pbh2-control/workspace/work/consistency` |

Read `/private/tmp/pbh2-control/workspace/harness/AGENTS.md` and `/private/tmp/pbh2-control/workspace/harness/SKILL.md`. They bind you.
...
`python3 /private/tmp/pbh2-control/workspace/harness/scripts/pb_execution.py authorize` **answers a question** — may work begin
against this candidate now — and confers nothing. `python3 /private/tmp/pbh2-control/workspace/harness/scripts/pb_execution.py admit`
...
1. place its contract into the run root, substituting the candidate you established:
   `python3 /private/tmp/pbh2-control/workspace/harness/evals/authority_slice/pb_slice.py place-contract --workdir /private/tmp/pbh2-control/workspace/work --task RQ-impl --candidate <the candidate>`
2. admit it — this authorizes and binds in one act, and is the only route by which a
   ...
   `python3 /private/tmp/pbh2-control/workspace/harness/scripts/pb_execution.py admit --run-root /private/tmp/pbh2-control/workspace/work/project/DeepSeekAndDestroy/plans/slice/runs/r1 --phase-id build --task-id RQ-impl --contract <the contract> --graph /private/tmp/pbh2-control/workspace/work/project/change-graph.json --ledger /private/tmp/pbh2-control/workspace/work/ledger.json --project-root /private/tmp/pbh2-control/workspace/work/project --consistency /private/tmp/pbh2-control/workspace/work/consistency`
3. launch the implementer **through the guarded path**, which is the only way a worker may be
   started in this run:
   `python3 /private/tmp/pbh2-control/workspace/harness/evals/authority_slice/pb_slice.py launch --workdir /private/tmp/pbh2-control/workspace/work --phase build --task RQ-impl --role implementer`
4. gate it: `python3 /private/tmp/pbh2-control/workspace/harness/scripts/dsd_attempt.py gate --run-root /private/tmp/pbh2-control/workspace/work/project/DeepSeekAndDestroy/plans/slice/runs/r1 --phase-id build --task-id RQ-impl`
5. launch a fresh independent review of the same task and the same contract, giving it the
   ...
   `python3 /private/tmp/pbh2-control/workspace/harness/evals/authority_slice/pb_slice.py launch --workdir /private/tmp/pbh2-control/workspace/work --phase build --task RQ-impl --role reviewer --input <the implementer's report.md>`
6. gate it, and read what it says;
7. run the external check on the delivered artifact:
   `python3 /private/tmp/pbh2-control/workspace/harness/evals/authority_slice/pb_slice.py check-artifact --workdir /private/tmp/pbh2-control/workspace/work`
8. decide. If you accept:
   `python3 /private/tmp/pbh2-control/workspace/harness/scripts/dsd_state.py accept-task --run-root /private/tmp/pbh2-control/workspace/work/project/DeepSeekAndDestroy/plans/slice/runs/r1 --phase-id build --task-id RQ-impl --evidence-gate <the reviewer's evidence-gate.json>`
...
`python3 /private/tmp/pbh2-control/workspace/harness/evals/authority_slice/pb_slice.py account --workdir /private/tmp/pbh2-control/workspace/work` shows what has
