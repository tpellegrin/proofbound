# Eval V1 — semantic reflection reliability

> **The V1 operating instructions, preserved.** This was `evals/README.md` until 2026-09-17, when
> that file became a guide to the whole evaluation system. Nothing below is changed except this
> header: V1's prerequisites, usage, scenario populations and authoring rules are still exactly how
> V1 is run. Start at [`README.md`](README.md) for how V1 relates to everything else here.
