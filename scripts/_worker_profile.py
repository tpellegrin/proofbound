#!/usr/bin/env python3
"""Observed worker usage, calls, tool activity and elapsed time from OpenCode SQLite rows.

Unknown measurements remain unavailable. Resource observations never judge engineering quality.
The evaluation import is a compatibility alias for this production implementation.
"""
