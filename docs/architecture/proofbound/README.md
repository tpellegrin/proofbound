...
| Modularity and local reasoning | **Designed; fixture not built** — one measurand, the size of the module representation correct reasoning required, with correctness as its gate |
