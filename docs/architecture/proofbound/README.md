...
| Modularity and local reasoning | **Fixture built** (MLR-C1); five gates pass, headroom pending, and the approved internal control is blocked on executor read-policy mechanics |
